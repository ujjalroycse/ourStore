                        ...
                        <div class="card mb-0">
                            <div class="card-body text-center">
                                ...
                                <form class="mt-5 mb-5">
                                    ...
                                    <div class="text-center mb-4 mt-4"><a href="logout.php" class="btn btn-primary">Go to Homepage</a>
                                    </div>
                                </form>
                                <div class="text-center">
                                    <p>Your Account Is Blocked...<mark class="bg-warning text-white">Contact your admin..</mark></p>
